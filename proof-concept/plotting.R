...
df1_grouped_country <- df1 %>% group_by(mob_affil, country_code_origin) %>% 
  summarise(researchers_count = n(),.groups = 'drop') %>%
  as.data.frame()

# Group researchers by mobility/affiliation and active years
df1_grouped_years <- df1 %>% group_by(mob_affil, active_years) %>% 
  summarise(researchers_count = n(),.groups = 'drop') %>%
  as.data.frame()

# Group researchers by mobility/affiliation, active years and country
df1_grouped_years_country <- df1 %>% group_by(mob_affil, active_years, country_code_origin) %>% 
  summarise(researchers_count = n(),.groups = 'drop') %>%
  as.data.frame()

# Group researchers by mobility/affiliation and publications
df1_grouped_pubs <- df1 %>% group_by(mob_affil, total_p) %>% 
  summarise(researchers_count = n(),.groups = 'drop') %>%
  as.data.frame()

# Group researchers by mobility/affiliation, publications and country
df1_grouped_pubs_country <- df1 %>% group_by(mob_affil, total_p, country_code_origin) %>% 
  summarise(researchers_count = n(),.groups = 'drop') %>%
  as.data.frame()

## Data filtering for plotting purposes
df1_grouped_country_nonmob_filter <- filter(df1_grouped_country, mob_affil != "non-mobile")

df1_p100_filter <- filter(df1, total_p <= 100)

df1_t30_filter <- filter(df1, total_topics <= 30)

df1_p150_filter <- filter(df1, total_p <= 150)

df1_t40_filter <- filter(df1, total_topics <= 40)

df1_grouped_years_nonmob_filter <- filter(df1_grouped_years, mob_affil != "non-mobile")

df1_grouped_years_country_nonmob_filter <- filter(df1_grouped_years_country, mob_affil != "non-mobile")

df1_grouped_p50_filter <- filter(df1_grouped_pubs, total_p <= 50)

df1_grouped_p50_nonmob_filter <- filter(df1_grouped_pubs, total_p <= 50 & mob_affil != "non-mobile")

df1_grouped_p50_country_filter <- filter(df1_grouped_pubs_country, total_p <= 50)

df1_grouped_p50_country_nonmob_filter <- filter(df1_grouped_pubs_country, total_p <= 50 & mob_affil != "non-mobile")

## Plotting
# 0A) grouped barplot: RESEARCHERS by COUNTRY and MOB/AFFIL
ggplot(df1_grouped_country, aes(x = country_code_origin, y = researchers_count, fill = mob_affil, color = mob_affil)) +
...
ggplot(df1_grouped_country_nonmob_filter, aes(x = country_code_origin, y = researchers_count, fill = mob_affil, color = mob_affil)) +
  geom_bar(stat="identity", position="dodge") +
  theme_minimal() +
...
ggplot(df1_p100_filter, aes(x = total_p, y = mob_affil, fill = mob_affil, color = mob_affil)) +
  geom_boxplot() +
  theme_minimal() +
...
ggplot(df1_t30_filter, aes(x = total_topics, y = mob_affil, fill = mob_affil, color = mob_affil)) +
  geom_boxplot() +
  theme_minimal() +
...
ggplot(df1_p150_filter, aes(x = active_years, y = total_p, fill = factor(mob_affil), color = factor(mob_affil))) +
  geom_boxplot() +
  theme_minimal() +
...
ggplot(df1_t40_filter, aes(x = active_years, y = total_topics, fill = factor(mob_affil), color = factor(mob_affil))) +
  geom_boxplot() +
  theme_minimal() +
...
ggplot(df1, aes(x = active_years, y = cl_p, fill = factor(mob_affil), color = factor(mob_affil))) +
  geom_boxplot() +
  theme_minimal() +
...
ggplot(df1, aes(x = active_years, y = proportion_cl_int, fill = factor(mob_affil), color = factor(mob_affil))) +
  geom_boxplot() +
  theme_minimal() +
...
ggplot(df1_grouped_years, aes(x = active_years, y = researchers_count, fill = mob_affil, color = mob_affil)) +
  geom_bar(stat="identity", position="dodge") +
  theme_minimal() +
...
ggplot(df1_grouped_years_nonmob_filter, aes(x = active_years, y = researchers_count, fill = mob_affil, color = mob_affil)) +
  geom_bar(stat="identity", position="dodge") +
  theme_minimal() +
...
ggplot(df1_grouped_years_country, aes(x = active_years, y = researchers_count, fill = mob_affil, color = mob_affil)) +
  geom_bar(stat="identity", position="dodge") +
  facet_wrap(~country_code_origin) +
  theme_minimal() +
...
ggplot(df1_grouped_years_country_nonmob_filter, aes(x = active_years, y = researchers_count, fill = mob_affil, color = mob_affil)) +
  geom_bar(stat="identity", position="dodge") +
  facet_wrap(~country_code_origin) +
  theme_minimal() +
...
ggplot(df1_grouped_p50_filter, aes(x = total_p, y = researchers_count, fill = mob_affil, color = mob_affil)) +
  geom_bar(stat="identity", position="dodge") +
  theme_minimal() +
...
ggplot(df1_grouped_p50_nonmob_filter, aes(x = total_p, y = researchers_count, fill = mob_affil, color = mob_affil)) +
  geom_bar(stat="identity", position="dodge") +
  theme_minimal() +
...
ggplot(df1_grouped_p50_country_filter, aes(x = total_p, y = researchers_count, fill = mob_affil, color = mob_affil)) +
  geom_bar(stat="identity", position="dodge") +
  facet_wrap(~country_code_origin) +
  theme_minimal() +
...
ggplot(df1_grouped_p50_country_nonmob_filter, aes(x = total_p, y = researchers_count, fill = mob_affil, color = mob_affil)) +
  geom_bar(stat="identity", position="dodge") +
  facet_wrap(~country_code_origin) +
  theme_minimal() +
...
ggplot(df1_t40_filter, aes(x = total_topics, y = active_years, fill = active_years, color = active_years)) +
